                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="temper" class="form-control" placeholder="ປ້ອນອຸນຫະພູມ (ອົງສາ °C)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="respira" class="form-control" placeholder="ປ້ອນທາງເດີນຫາຍໃຈ">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="pulse" class="form-control" placeholder="ປ້ອນຊີບພະຈອນ">
                                    </div>
                                </div>
                            </div>
                        </div>
