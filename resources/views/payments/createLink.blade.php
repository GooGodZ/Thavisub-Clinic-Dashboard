                    ...
                    <div class="card-body-content-form">
                        <form action="{{ route('payments.store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="number" name="price_p" class="form-control" placeholder="ປ້ອນລວມລາຄາຢາ">
                                    @error('price_p')
                                        <strong style="color: red; margin-top: 0.625rem">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="number" name="price_e" class="form-control" placeholder="ປ້ອນລວມລາຄາປິ່ນປົວ">
                                    @error('price_e')
                                        <strong style="color: red; margin-top: 0.625rem">{{ $message }}</strong>
                                    @enderror
                                </div>
