                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <select name="c_id" class="form-select">
                                            ...
                                            <option value="{{ $cases->id }}" @if(old('cases')==$cases->id || $cases->id == $evaluations->c_id) selected @endif>{{ $cases->c_no. " " .$cases->patients->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <select name="et_id" class="form-select">
                                            ...
                                            <option value="{{ $evaluation_types->id }}" @if(old('evaluation_types')==$evaluation_types->id || $evaluation_types->id == $evaluations->et_id) selected @endif>{{ $evaluation_types->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <textarea type="text" name="detail" value="{{ old('evaluations', $evaluations->detail ?? null) }}" class="form-control" placeholder="ປ້ອນລາຍລະອຽດຜົນກວດ" rows="5">{{ $evaluations->detail }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
