        ...
        <div class="card">
            <div class="container">
                <div class="card-body-content-button">
                    <a href="{{ route('evaluations.create') }}"><button><i class="fa-solid fa-plus"></i>&nbsp;ເພີ່ມ</button></a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('evaluations.destroy', $evaluations->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{ route('evaluations.edit', $evaluations->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
