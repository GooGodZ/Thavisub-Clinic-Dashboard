        ...
        <div class="card">
            <div class="container">
                <div class="card-body-content-button">
                    <a href="{{ route('evaluation_types.create') }}"><button><i class="fa-solid fa-plus"></i>&nbsp;ເພີ່ມ</button></a>
                </div>
                    ...
                    <table id="mytable" class="table table-hover" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('evaluation_types.destroy', $evaluation_types->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{ route('evaluation_types.edit', $evaluation_types->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
