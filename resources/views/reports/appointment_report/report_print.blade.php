    ...
    <div class="container">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center">
            ...
            <div class="row">
                ...
                <div class="col-5">
                    <h4 class="text-end">ເລກທີ: {{ $appointment->ap_no }}</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-7">
            ...
            <div class="card border-0 mx-5">
                <table class="table table-borderless">
                    <tr>
                        ...
                        <td>
                            <h4>{{ $appointment->doctors->name }}</h4>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <h4>{{ $appointment->cases->patients->name }}</h4>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <h4>{{ date('d / m / Y', strtotime($appointment->date)) }}</h4>
                        </td>
                    </tr>
                    <tr>
                        <th>
