                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#cases" type="button"
                                style="font-weight: 600">ລໍຖ້າກວດ</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#casestoday" type="button"
                                style="font-weight: 600">ກວດແລ້ວ</button>
                        </li>
                    </ul>
