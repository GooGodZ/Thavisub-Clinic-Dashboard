/*! jQuery v2.2.0 | (c) jQuery Foundation | jquery.org/license */ !(function (a, b) {
    ...
    n.extend({
        ...
        when: function (a) {
            ...
            if (d > 1)
                for (
                    i = new Array(d), j = new Array(d), k = new Array(d); d > b; b++
                )
    ...
    function ua(a, b, c, d) {
        ...
        if (
            ...
            if (i)
                for (
                    k = h[h.length - 1].ownerDocument, n.map(h, ra), m = 0; i > m; m++
                )
                    (j = h[m]),
                    Z.test(j.type || "") &&
    ...
    n.extend({
            ...
            clone: function (a, b, c) {
                ...
                if (b)
                    if (c)
                        for (
                            f = f || _(a), g = g || _(h), d = 0, e = f.length; e > d; d++
                        )
                            sa(f[d], g[d]);
                    else sa(a, h);
                return (
            ...
            cleanData: function (a) {
                for (
                    var b, c, d, e = n.event.special, f = 0; void 0 !== (c = a[f]); f++
                )
                    if (L(c)) {
                        if ((b = c[N.expando])) {
                            if (b.events)
        ...
        n.each({
            ...
            function (a, b) {
                n.fn[a] = function (a) {
                    for (
                        var c, d = [], e = n(a), f = e.length - 1, h = 0; f >= h; h++
                    )
